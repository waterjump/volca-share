...
Devise.setup do |config|
  ...
  config.secret_key = 'a8aeafc3bde59a0e8d26a8375362d25f18ef5cd0ac4473ed6fe81e58eac8b3ffde2eb3d5eed74053c889df45f8938641f84736fb8823d923736d494644acb351'

  # ==> Mailer Configuration
  # Configure the e-mail address which will be shown in Devise::Mailer,
  # note that it will be overwritten if you use your own mailer class
  # with default "from" parameter.
  config.mailer_sender = ENV['PASSWORD_RESET_FROM_ADDRESS']
  ...
  # will eenable it only for database authentication. The supported strategies
  # are:
  ...
  # config.pepper =
  #   '5b9acf5582208777a05c9037d501a6b1a6683de39e45017dce6d13381a5be9c4b2e899f'\
  #   'a8accd520a85c72b920afa2696c385083a8286576385465d6247c79e0'
