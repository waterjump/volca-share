...
class MysteryPatch
  ...
  def self.generate_random(overrides: {})
    ...
    new(
      ...
      detune: rand(128),
      portamento: rand(128),
      vco_eg_int: random_param(preferred_weight: 3, total_weight: 4),
      cutoff: cutoff_val,
      peak: rand(128),
      vcf_eg_int: vcf_eg_int_val,
      lfo_rate: rand(128),
      lfo_pitch_int: random_param(preferred_weight: 3, total_weight: 4),
      lfo_cutoff_int: random_param(preferred_weight: 3, total_weight: 4),
      attack: random_param(preferred_weight: 2, total_weight: 3),
      decay_release: rand(128),
      sustain: rand(128),
      delay_time: rand(128),
      delay_feedback: random_param(preferred_weight: 3, total_weight: 4),
